...
with col1:
    ...
    if Get_data or st.session_state.get("Get_state",False):
        ...
        api_version = 'v3'
        api_key = 'AIzaSyAX1guY7tnNCABoezz6tP0f-AvkqZM4HfA'
...
with col2:
    ...
    if Migrate or st.session_state_migrate_sql:
        ...
        engine = create_engine('mysql+mysqlconnector://root:12345@localhost:3306/youtube_database', echo=False)
...
if question_tosql:
    connect_for_question = mysql.connector.connect(host='localhost', user='root', password='12345', db='youtube_database')
